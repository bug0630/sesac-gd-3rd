...
container.append(p1, "이건 그냥 텍스트 넣은 거에요");

// appendChild
// 선택된 요소의 자식요소로 매개변수 요소가 추가되는데, 가장 뒤에 요소가 추가됨
...
p3.innerText = "appendChild 사용해서 추가할 세 번째 p태그";

container.appendChild(p2);
container.appendChild(p3);
// container.appendChild(p4);
// container.appendChild(p3, p4); //p4는 추가되지 않음
// container.appendChild("과연될까요"); //텍스트 추가 안됨
...
/*
  ...
  - 부모.append(요소) : 해당 요소를 부모요소의 마지막 자식으로 추가
    - 여러개의 요소 한 번에 추가 가능
  ...
  before, after -> 선택된 요소의 형ㅇ제레ㅗ 인자로 전달한 요소를 추가
*/

// 요소 삭제
const deleteDiv = document.querySelector(".container div");
deleteDiv.remove(); //선택한 요소 삭제
const rose = document.querySelector("#flower li:nth-of-type(2)");
rose.remove();
